# Boilerplate professional developer portfolio website

A sign of mature developer is that they develop quickly what's necessary and _don't develop what's unnessary_

In concrete terms now python main.py and json files as database - all you need until your work is interacted by at least thousand of users..
Thus it's prudent to showcase that idea on a developer portfolio website
...
## How To develop and launch something in few minutes
  ...
  Start with the design prompt and best suitable model on some top level interface such using
  
  "_you're an expert python backend developer
...
This website purpose is just to detail your developer experience content and list ways to contact and gather relevant data about you, nothing else
